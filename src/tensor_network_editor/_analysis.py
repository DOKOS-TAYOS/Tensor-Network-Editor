...
def analyze_network(spec: NetworkSpec) -> NetworkAnalysis:
    ...
    for edge in spec.edges:
        ...
        right_tensor_by_edge_id[edge.id] = right_item[0] if right_item is not None else None
        right_index_by_edge_id[edge.id] = right_item[1] if right_item is not None else None
